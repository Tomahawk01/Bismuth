...
void vulkan_renderer_begin_rendering(struct renderer_backend_interface* backend, struct frame_data* p_frame_data, u32 color_target_count, struct texture_internal_data** color_targets, struct texture_internal_data* depth_stencil_target, u32 depth_stencil_layer);
