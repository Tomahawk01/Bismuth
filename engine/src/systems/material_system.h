...
BAPI b8 material_system_apply_global(u32 shader_id, u64 renderer_frame_number, u8 renderer_draw_index, const mat4* projection, const mat4* view, const vec4* ambient_color, const vec3* view_position, u32 render_mode);
