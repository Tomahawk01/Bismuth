...
void input_update(f64 delta_time)
{
    ...
    bcopy_memory(&state.keyboard_previous, &state.keyboard_current, sizeof(keyboard_state));
    bcopy_memory(&state.mouse_previous, &state.mouse_current, sizeof(mouse_state));
}
