...
BAPI void* _darray_create(u64 length, u64 stride);
BAPI void _darray_destroy(void* array);

BAPI u64 _darray_field_get(void* array, u64 field);
BAPI void _darray_field_set(void* array, u64 field, u64 value);

BAPI void* _darray_resize(void* array);

BAPI void* _darray_push(void* array, const void* value_ptr);
BAPI void _darray_pop(void* array, void* dest);

BAPI void* _darray_pop_at(void* array, u64 index, void* dest);
