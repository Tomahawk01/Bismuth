 ...
 */
BAPI void hashtable_create(u64 element_size, u32 element_count, void* memory, b8 is_pointer_type, hashtable* out_hashtable);
 ...
 */
BAPI void hashtable_destroy(hashtable* table);
 ...
 */
BAPI b8 hashtable_set(hashtable* table, const char* name, void* value);
 ...
 */
BAPI b8 hashtable_set_ptr(hashtable* table, const char* name, void** value);
 ...
 * @return True; or false if a null pointer is passed.
 */
BAPI b8 hashtable_get(hashtable* table, const char* name, void* out_value);
 ...
 */
BAPI b8 hashtable_get_ptr(hashtable* table, const char* name, void** out_value);
 ...
 */
BAPI b8 hashtable_fill(hashtable* table, void* value);
