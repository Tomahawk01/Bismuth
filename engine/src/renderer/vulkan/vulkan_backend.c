...
b8 vulkan_renderer_shader_acquire_instance_resources(shader* s, u32* out_instance_id)
{
    ...
    *out_instance_id = INVALID_ID;
    ...
    instance_state->instance_textures = ballocate(sizeof(texture*) * s->instance_texture_count, MEMORY_TAG_ARRAY);
...
b8 vulkan_renderer_shader_release_instance_resources(shader* s, u32 instance_id)
{
    ...
    {
        bfree(instance_state->instance_textures, sizeof(texture*) * s->instance_texture_count, MEMORY_TAG_ARRAY);
