...
b8 editor_rendergraph_create(const editor_rendergraph_config* config, editor_rendergraph* out_graph)
{
    ...
    RG_CHECK(rendergraph_pass_sink_add(&out_graph->internal_graph, "editor", "colorbuffer"));
    RG_CHECK(rendergraph_pass_sink_add(&out_graph->internal_graph, "editor", "depthbuffer"));
    RG_CHECK(rendergraph_pass_source_add(&out_graph->internal_graph, "editor", "colorbuffer", RENDERGRAPH_SOURCE_TYPE_RENDER_TARGET_COLOR, RENDERGRAPH_SOURCE_ORIGIN_OTHER));
    ...
    RG_CHECK(rendergraph_pass_set_sink_linkage(&out_graph->internal_graph, "editor", "colorbuffer", 0, "colorbuffer"));
