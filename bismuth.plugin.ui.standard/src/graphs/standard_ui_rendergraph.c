...
b8 standard_ui_rendergraph_create(const standard_ui_rendergraph_config* config, standard_ui_rendergraph* out_graph)
{
    ...
    RG_CHECK(rendergraph_pass_sink_add(&out_graph->internal_graph, "ui", "colorbuffer"));
    RG_CHECK(rendergraph_pass_sink_add(&out_graph->internal_graph, "ui", "depthbuffer"));
    RG_CHECK(rendergraph_pass_source_add(&out_graph->internal_graph, "ui", "colorbuffer", RENDERGRAPH_SOURCE_TYPE_RENDER_TARGET_COLOR, RENDERGRAPH_SOURCE_ORIGIN_OTHER));
    ...
    RG_CHECK(rendergraph_pass_set_sink_linkage(&out_graph->internal_graph, "ui", "colorbuffer", 0, "colorbuffer"));
