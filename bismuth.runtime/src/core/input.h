 ...
 */
BAPI b8 input_was_key_up(keys key);
 ...
 * @returns True if currently pressed; otherwise false.
 */
BAPI b8 input_is_button_down(mouse_buttons button);
 ...
 * @returns True if currently released; otherwise false.
 */
BAPI b8 input_is_button_up(mouse_buttons button);
 ...
 */
BAPI b8 input_was_button_down(mouse_buttons button);
 ...
 * @returns True if previously released; otherwise false.
 */
BAPI b8 input_was_button_up(mouse_buttons button);
 ...
 */
BAPI b8 input_is_button_dragging(mouse_buttons button);
