...
BAPI b8 bresource_system_request(struct bresource_system_state* state, bname name, bresource_type type, bresource_request_info info, bresource* out_resource);
