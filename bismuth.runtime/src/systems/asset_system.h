...
BAPI void asset_system_request(struct asset_system_state* state, basset_type type, bname package_name, bname asset_name, b8 auto_release, void* listener_inst, PFN_basset_on_result callback, u32 import_params_size, void* import_params);
