...
BAPI void asset_system_request(struct asset_system_state* state, const char* fully_qualified_name, b8 auto_release, void* listener_inst, PFN_basset_on_result callback);
BAPI void asset_system_release(struct asset_system_state* state, const char* name);
