...
BAPI b8 bphysics_body_create_sphere(struct bphysics_system_state* state, bname name, vec3 position, f32 radius, bphysics_body_type body_type, bhandle* out_body);
BAPI b8 bphysics_body_create_rectangle(struct bphysics_system_state* state, bname name, vec3 position, vec3 half_extents, bphysics_body_type body_type, bhandle* out_body);
BAPI b8 bphysics_body_create_mesh(struct bphysics_system_state* state, bname name, vec3 position, u32 triangle_count, triangle_3d* tris, bphysics_body_type body_type, bhandle* out_body);
