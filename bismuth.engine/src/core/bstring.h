...
/**
 * @brief Attempts to parse a xform config from the provided string.
 ...
 */
BAPI b8 string_to_xform_config(const char* str, struct scene_xform_config* out_xform);
 ...
 */
BAPI const char* i8_to_string(const char* str, i8 i);
 ...
 * @return The string representation of the provided integer.
 */
BAPI const char* i16_to_string(const char* str, i16 i);
 ...
 * @return The string representation of the provided integer.
 */
BAPI const char* i32_to_string(const char* str, i32 i);
 ...
 * @return The string representation of the provided integer.
 */
BAPI const char* i64_to_string(const char* str, i64 i);
 ...
 * @return The string representation of the provided integer.
 */
BAPI const char* u8_to_string(const char* str, u8 u);
 ...
 * @return The string representation of the provided integer.
 */
BAPI const char* u16_to_string(const char* str, u16 u);
 ...
 * @return The string representation of the provided integer.
 */
BAPI const char* u32_to_string(const char* str, u32 u);
 ...
 * @return The string representation of the provided integer.
 */
BAPI const char* u64_to_string(const char* str, u64 u);
 ...
 */
BAPI const char* bool_to_string(const char* str, b8 b);
