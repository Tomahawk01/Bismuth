...
typedef struct geometry_config
{
    ...
    char name[GEOMETRY_NAME_MAX_LENGTH]; // FIXME: Should dynamically allocate this
    /** @brief Name of the material used by the geometry */
    char material_name[256]; // FIXME: Should dynamically allocate this
} geometry_config;
...
BAPI void generate_quad_2d(const char *name, f32 width, f32 height, f32 tx_min, f32 tx_max, f32 ty_min, f32 ty_max, geometry_config *out_config);
