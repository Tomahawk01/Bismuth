...
const char* basset_material_texture_map_channel_to_string(basset_material_texture_map_channel channel)
{
    switch (channel)
    {
    default:
...
basset_material_texture_map_channel string_to_basset_material_texture_map_channel(const char* str)
{
...
const char* basset_material_type_to_string(basset_material_type type)
{
    switch (type)
    {
...
basset_material_type string_to_basset_material_type(const char* str)
{
...
const char* basset_material_model_to_string(basset_material_model model)
{
    switch (model)
    {
...
basset_material_model string_to_basset_material_model(const char* str)
{
