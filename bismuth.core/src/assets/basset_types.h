...
typedef enum basset_type
{
    ...
    BASSET_TYPE_IMAGE = 1,
    BASSET_TYPE_MATERIAL = 2,
    BASSET_TYPE_STATIC_MESH = 3,
    BASSET_TYPE_HEIGHTMAP_TERRAIN = 4,
    BASSET_TYPE_SCENE = 5,
    BASSET_TYPE_BITMAP_FONT = 6,
    BASSET_TYPE_SYSTEM_FONT = 7,
    BASSET_TYPE_TEXT = 8,
    BASSET_TYPE_BINARY = 9,
    BASSET_TYPE_BSON = 10,
    BASSET_TYPE_VOXEL_TERRAIN = 11,
    BASSET_TYPE_SKELETAL_MESH = 12,
    BASSET_TYPE_AUDIO = 13,
    BASSET_TYPE_SHADER = 14,
