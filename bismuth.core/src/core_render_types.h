...
/** @brief Configuration for a shader. Typically created and destroyed by the shader resource loader, and set to the properties found in a .shadercfg resource file */
